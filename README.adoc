...
|*Learn with SHAKTI* | https://shakti.org.in/team.html[Shakti - RISE Lab, IITM] | A tutorial on RISC-V                                      
assembly programming using the RISC-V toolchain (Spike, riscv-pk,                                           
OpenOCD) and basic examples and assignments. More elaborate RISC-V ASM                                      
examples can be found in the: https://shakti.org.in/docs/risc-v-asm-manual.pdf[Shakti RISC-V ASM Programmer Manual Part                                     
I]. |https://shakti.org.in/learn_with_shakti/intro.html[Link to: Learn with Shakti] |21-12-2023  
|===
